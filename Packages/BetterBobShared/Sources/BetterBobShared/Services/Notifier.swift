...
public enum Notifier {
    ...
    public static func autoBreakEnded() {
        guard Prefs.shared.notifyAutoBreak else { return }
        post(title: "Back to work",
             body: "Your auto-break is over — you're clocked back in.")
    }

    public static func insertedPastBreak(start: Date, end: Date) {
        guard Prefs.shared.notifyAutoBreak else { return }
    ...
    public static func targetReached(_ target: String) {
    ...
    public static func overDailyMax(_ max: String) {
    ...
    public static func deadlineApproaching(days: Int) {
    ...
    public static let awaitingCodeID = "betterbob.awaitingCode"
    ...
    public static func awaitingCode() {
    ...
    public static func updateInstalled(version: String) {
